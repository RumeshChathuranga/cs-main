...
export function WorldMap({
  ...
  return (
    <div className="relative aspect-2/1 w-full overflow-hidden rounded-2xl bg-white font-sans md:aspect-2.5/1 lg:aspect-2/1">
      ...
      >
        <defs>
          <linearGradient id="gt-path-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-4 left-4 rounded-lg border border-gray-200 bg-white/90 px-3 py-2 text-sm font-medium text-black shadow-md backdrop-blur-sm sm:hidden"
          >
            {hoveredLocation}
          </motion.div>
        )}
