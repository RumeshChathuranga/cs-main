...
export function Hero() {
  return (
    <section className="relative flex min-h-[85vh] flex-col justify-center overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-navy/65 via-navy/55 via-60% to-navy/80" />

      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-6 py-24 text-center">
        <span className="rounded-full border border-brand bg-brand/20 px-5 py-1.5 text-xs font-bold uppercase tracking-widest text-brand">
          AIESEC in Colombo South
        </span>

        <h1 className="mt-7 text-4xl font-extrabold leading-tight text-white md:text-5xl lg:text-6xl">
          Develop Your Leadership.{' '}
          <span className="text-brand">Change the World.</span>
        </h1>

        <p className="mt-7 max-w-2xl text-lg leading-8 text-white/90 md:text-xl">
          Join the world&apos;s largest youth-run organization and unlock
          international exchange experiences that transform lives.
        </p>
